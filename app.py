...
I want the response in the following structure: The first line indicates the percentage match with the job description (JD). The second line presents a list of missing keywords. The third section provides a profile summary. 
...
with col1: 
    img1 = Image.open(r"C:\Users\kiran\OneDrive\Pictures\ATS\Images\icon1.jpg") 
...
with col2: 
    img2 = Image.open(r"C:\Users\kiran\OneDrive\Pictures\ATS\Images\icon2.jpg") 
...
with col1: 
    img3 = Image.open(r"C:\Users\kiran\OneDrive\Pictures\ATS\Images\icon3.jpg") 
